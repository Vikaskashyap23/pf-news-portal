...
<div class="bg-[#111827] text-gray-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-9 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 text-[11px] font-semibold tracking-wide">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="h-20 flex items-center justify-between">
        ...
        {{-- BRAND --}}
        <a href="{{ $website ? url('/site/' . $website->slug) : route('frontend.home') }}"
           class="flex items-center gap-3 group">
            ...
            <div class="relative w-11 h-11 sm:w-12 sm:h-12
                ...
                <span class="text-xl sm:text-2xl font-black">N</span>
            </div>

            <div>
                <div class="text-2xl sm:text-3xl font-black tracking-tight
                            text-gray-900 group-hover:text-red-600 transition">

                    {{ $website->name }}

                </div>

                <div class="hidden sm:block text-[9px] uppercase
                            tracking-[0.3em] text-gray-500 font-semibold">
            ...
            <details class="relative z-[201]">
                ...
                <div class="absolute right-0 top-14
                    ...
                    @foreach($categories as $category)
                        ...
                        <a
                            href="{{ url('/site/' . $website->slug . '/category/' . $category->slug) }}"
                            class="block px-4 py-3 rounded-lg
                                   text-sm font-semibold
                                   text-gray-700
                                   hover:bg-gray-100
    ...
    <nav class="border-t border-gray-100">
        ...
        <div class="flex items-center gap-8
            ...
            <a
                href="{{ url('/site/' . $website->slug) }}"
                class="relative py-4 text-xs font-black uppercase
                       tracking-wide text-red-600">

                {{ __('messages.home') }}

                <span class="absolute left-0 right-0 bottom-0 h-0.5 bg-red-600"></span>
            ...
            @foreach($categories as $category)
                ...
                <a
                    href="{{ url('/site/' . $website->slug . '/category/' . $category->slug) }}"
                    class="relative py-4 text-xs font-bold uppercase
    ...
    <div class="max-w-7xl mx-auto flex items-stretch">
        ...
        <div class="relative flex-shrink-0
            ...
            <span class="relative flex h-2.5 w-2.5">
                ...
                <span class="absolute inline-flex h-full w-full
                             rounded-full bg-white opacity-50 animate-ping"></span>

                <span class="relative inline-flex rounded-full
                             h-2.5 w-2.5 bg-white"></span>
        ...
        <div class="flex-1 overflow-hidden">
            ...
            <div class="flex items-center gap-8
                        ...
                        px-5 py-3 scrollbar-hide">

                @foreach($breakingNews as $breaking)

                    <a
                        href="{{ frontend_news_url($breaking->slug, $website) }}"
                        ...
                        <span class="w-1 h-1 rounded-full
                                     bg-red-500 flex-shrink-0"></span>

                        <span class="group-hover:text-red-400 transition">
                            {{ $breaking->title }}
                        </span>
...
@if($featuredNews->count())
    ...
    <section class="mb-14">
        ...
        <div class="flex items-end justify-between
            ...
            <span class="hidden sm:block text-[10px]
        ...
        <div class="grid lg:grid-cols-12 gap-6 lg:gap-7">

            {{-- HERO --}}
            <article class="lg:col-span-7 group relative
                ...
                @if($hero->featured_image)
                    ...
                    <div class="relative aspect-[16/10]
                        ...
                        <div class="absolute left-0 right-0 bottom-0
                            ...
                            <a
                                href="{{ frontend_news_url($hero->slug, $website) }}"
                                class="block">

                                <h1 class="font-serif text-3xl sm:text-4xl
                                           lg:text-[42px]
                                           leading-[1.05]
            ...
            {{-- SECONDARY STORIES --}}
            <div class="lg:col-span-5 grid
                        sm:grid-cols-2 lg:grid-cols-1 gap-5">

                @foreach($secondaryNews as $index => $item)

                    <article class="group bg-white rounded-xl
                                    border border-gray-200
                        ...
                        <div class="flex h-full gap-4 p-3">
                            ...
                            @if($item->featured_image)
                                ...
                                <div class="relative w-32 sm:w-36 lg:w-40
                                            h-28 flex-shrink-0
                            ...
                            <div class="flex-1 min-w-0 py-1">
                                ...
                                <div class="flex items-center gap-2
                                            text-[10px] uppercase
                                            tracking-wider font-black mb-2">
                                ...
                                <a
                                    href="{{ frontend_news_url($item->slug, $website) }}"
                                    class="block">
    ...
    <aside class="lg:col-span-4 space-y-7">
        ...
        <section class="bg-white rounded-xl
            ...
            <div class="flex items-center justify-between
                        px-5 py-4 bg-[#111827] text-white">
            ...
            <div class="divide-y divide-gray-100">
                ...
                @foreach($latestNews->take(5) as $index => $item)
                    ...
                    <a
                        href="{{ frontend_news_url($item->slug, $website) }}"
                        class="group block p-5 hover:bg-gray-50 transition">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <button
                            ...
                            class="w-full rounded-lg
                                   bg-red-600 text-white py-3
                                   text-sm font-black uppercase
                                   tracking-wider hover:bg-red-700
                                   transition">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div class="lg:col-span-1">
            ...
            <a
                ...
                <div class="w-11 h-11 bg-red-600
...
<div id="searchOverlay"
     class="fixed inset-0 bg-black/60
            backdrop-blur-sm z-[100] hidden">

```
<div class="min-h-full flex items-start
            justify-center px-4 pt-24">

    <div class="w-full max-w-2xl bg-white
                rounded-2xl shadow-2xl p-5 sm:p-7">
